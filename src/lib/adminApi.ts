...
export { getAdminHouses as fetchAdminHouses, getAdminLeaderboard as fetchAdminLeaderboard, adjustLeaderboardPoints as adjustAdminLeaderboardPoints, getAdminDashboardSummary as fetchAdminDashboardSummary, getAttendanceReport as fetchAttendanceReport } from '@/api/admin/leaderboard'
...
export type { AdminLeaderboardDTO as AdminLeaderboardRow, AdminDashboardSummary, AttendanceReportDTO } from '@/api/admin/leaderboard'
