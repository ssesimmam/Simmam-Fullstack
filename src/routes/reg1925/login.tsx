...
function LoginPage() {
  ...
  const [selectedRole, setSelectedRole] = useState<AdminRole>('reg_team')
  ...
  }, [login, navigate, search.redirectTo, selectedRole])
            ...
            <div className="mt-8 space-y-6">
              <div className="space-y-3">
                <div className="rounded-lg border border-white/10 bg-white/5 p-4 text-sm text-gray-300">
                  <p className="font-semibold text-white">Registration team access only</p>
                  <p className="mt-1 text-xs text-gray-400">Continue with Google authentication to sign in.</p>
                </div>
              </div>
