...
export const Route = createFileRoute('/portal/live')({
  head: () => ({
    meta: [
      { title: 'Portal Live Dashboard — SIMMAM 2026' },
      {
        name: 'description',
        content: 'Backend-connected dashboard and live scores page under the portal section.',
      },
    ],
  }),
  component: PortalLivePage,
})

function PortalLivePage() {
  return (
